    ...
    >
      <GeneralExplanation>
        <Typography variant="body1">
          Subscribe to notifications for specific events or conditions within
          the Qortal ecosystem. This action allows apps to receive push
          notifications when certain criteria are met. Custom filters can be
          applied to control what triggers notifications.
        </Typography>
      </GeneralExplanation>
