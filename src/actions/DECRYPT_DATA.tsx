...
export const DECRYPT_DATA: React.FC<ComponentProps> = ({ myAddress }) => {
    ...
    >
      <GeneralExplanation>
        <Typography variant="body1">
          Decrypts data that was encrypted with the ENCRYPT_DATA qortalRequest.
          If the user's public key was part of the encryption process, then it
          will be able to decrypt the data. Returns the decrypted data in
          base64.
        </Typography>
      </GeneralExplanation>
