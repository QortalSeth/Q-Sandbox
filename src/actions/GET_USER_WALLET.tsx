...
export const GET_USER_WALLET: React.FC<ComponentProps> = ({ myAddress }) => {
    ...
    >
      <GeneralExplanation>
        ...
        >
          ...
          />
          <Typography>
            The coin ARRR cannot be used through the gateway. When using a local
            node, for ARRR only the address will be returned.
          </Typography>
        </Box>
      </GeneralExplanation>
