...
export const ENCRYPT_DATA_WITH_SHARING_KEY: React.FC<ComponentProps> = ({
  myAddress,
}) => {
    ...
    >
      <GeneralExplanation>
        <Typography variant="body1">
          Encrypts data provided by the user which can later be decrypted by
          anyone who has the sharing key. The user that encrypted the data with
          this qortalRequest will be able to use the "DECRYPT_DATA"
          qortalRequest to retrieve the key. The recipient of the key will be
          able to also decrypt the data using "DECRYPT_DATA_WITH_SHARING_KEY"
          The publicKeys is optional in this case. Add other publicKeys if you
          want other users that you trust to also be able to share the sharing
          key.
        </Typography>
        <Typography variant="body1">
          If you plan on publishing the returned encrypted data, it needs to be
          published to a SERVICE with _PRIVATE
        </Typography>
      </GeneralExplanation>
      ...
      <Card>
        ...
        <div className="message-row">
          ...
          >
            ...
            <Spacer height="5px" />
            <Typography>Enter a list of public keys.</Typography>
          </Box>
          <Spacer height="20px" />
          <Button
            name="Encrypt Data"
