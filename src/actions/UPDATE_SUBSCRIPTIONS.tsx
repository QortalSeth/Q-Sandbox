...
export const UPDATE_SUBSCRIPTIONS: React.FC<ComponentProps> = ({ myAddress }) => {
    ...
    >
      <GeneralExplanation>
        <Typography variant="body1">
          Update the list of subscriptions for the current user. This action
          refreshes the subscription data from the Qortal network.
        </Typography>
      ...
      <Card>
        ...
        <div className="message-row">
          ...
          >
            ...
            <Spacer height="5px" />
            <Typography>
              Simply click the button below to update subscriptions.
            </Typography>
            <Spacer height="20px" />
            <Button
