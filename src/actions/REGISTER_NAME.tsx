...
export const REGISTER_NAME: React.FC<ComponentProps> = ({ myAddress }) => {
...
`.trim();
  ...
  return (
    ...
    >
      <GeneralExplanation>
        <Typography variant="body1">Register a Qortal name</Typography>
      </GeneralExplanation>
      ...
      <Card>
        ...
        <div className="message-row">
          ...
          >
            ...
            <Spacer height="5px" />
            <Typography>Enter a description</Typography>
            <Spacer height="5px" />
