...
export const NOTIFICATION_HAS_PERMISSION = () => {
...
`.trim();
  ...
  const tsInterface = `
interface NotificationHasPermissionRequest {
  action: string;
}
`.trim();
    ...
    >
      <GeneralExplanation>
        <Typography variant="body1">
          Check whether the current application has permission to send
          notifications. This action verifies the notification permission status
          without requesting new permissions. It's useful for conditional logic
      ...
      <Card>
        ...
        <div className="message-row">
          ...
          >
            ...
            <Spacer height="5px" />
            <Typography>
              Simply click the button below to check notification permission.
            </Typography>
          </Box>
          <Spacer height="20px" />
          <Button
