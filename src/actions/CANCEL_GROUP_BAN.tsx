...
export const CANCEL_GROUP_BAN: React.FC<ComponentProps> = ({ myAddress }) => {
    ...
    >
      <GeneralExplanation>
        <Typography variant="body1">
          qortalRequest to cancel a user ban for a group.
        </Typography>
        <Typography variant="body1">
          Only the group owner can process this transaction
        </Typography>
      ...
      <Card>
        ...
        <div className="message-row">
          ...
          >
            ...
            <Spacer height="5px" />
            <Typography>
              Enter the qortal Address of the user you are trying to unban.
            </Typography>
          </Box>
          <Spacer height="20px" />
          <Button
