...
export const DELETE_LIST_ITEM: React.FC<ComponentProps> = ({ myAddress }) => {
    ...
    >
      <GeneralExplanation>
        <Typography variant="body1">
          The DELETE_LIST_ITEM endpoint delete string values from a list array.
          This list is stored on the user's node.
        </Typography>
        <Typography variant="body1">
        ...
        <div className="message-row">
          ...
          >
            ...
            <Typography>
              ...
              using the qortalRequest. This list of to be removed items will not
