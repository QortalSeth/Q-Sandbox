...
export const REMOVE_GROUP_ADMIN: React.FC<ComponentProps> = ({ myAddress }) => {
    ...
    >
      <GeneralExplanation>
        <Typography variant="body1">
          qortalRequest to remove a group admin.
        </Typography>
      ...
      <Card>
        ...
        <div className="message-row">
          ...
          >
            ...
            <Spacer height="5px" />
            <Typography>
              Enter the Qortal address of the user you are trying to remove as
              admin.
            </Typography>
          </Box>
          <Spacer height="20px" />
