...
export const NOTIFICATION_GET: React.FC<ComponentProps> = ({ myAddress }) => {
    ...
    >
      <GeneralExplanation>
        <Typography variant="body1">
          Retrieve all notifications for the current user. This action fetches
          the list of pending and seen notifications from the Qortal Hub.
        </Typography>
      ...
      <Card>
        ...
        <div className="message-row">
          ...
          >
            ...
            <Spacer height="5px" />
            <Typography>
              Simply click the button below to retrieve notifications.
            </Typography>
            <Spacer height="20px" />
            <Button
