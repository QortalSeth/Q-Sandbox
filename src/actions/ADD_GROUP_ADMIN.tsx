...
export const ADD_GROUP_ADMIN: React.FC<ComponentProps> = ({ myAddress }) => {
    ...
    >
      <GeneralExplanation>
        <Typography variant="body1">
          qortalRequest to add a group admin.
        </Typography>
        <Typography variant="body1">
          The account that is being promoted to admin needs to be part of the
          group.
        </Typography>
      ...
      <Card>
        ...
        <div className="message-row">
          ...
          >
            ...
            <Spacer height="5px" />
            <Typography>
              Enter the Qortal address of the user you are trying to promote to
              admin.
            </Typography>
          </Box>
          <Spacer height="20px" />
