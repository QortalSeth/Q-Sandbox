...
export const services = [
  ...
  { name: "AUTO_UPDATE", sizeInBytes: maxSize, sizeLabel: sizeLabel(maxSize) },
  { name: "BLOG", sizeInBytes: maxSize, sizeLabel: sizeLabel(maxSize) },
  {
    name: "BLOG_COMMENT",
    sizeInBytes: minSize,
    sizeLabel: sizeLabel(minSize),
  },
  { name: "BLOG_POST", sizeInBytes: maxSize, sizeLabel: sizeLabel(maxSize) },
  ...
  { name: "DOCUMENT", sizeInBytes: maxSize, sizeLabel: sizeLabel(maxSize) },
  {
  ...
  { name: "PRODUCT", sizeInBytes: maxSize, sizeLabel: sizeLabel(maxSize) },
  {
